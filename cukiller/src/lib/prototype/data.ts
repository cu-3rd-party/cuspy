...
export const enlistNav: BottomNavItem[] = [
	{ href: '/agent-id', label: 'ID', icon: 'fingerprint', group: 'enlist', match: 'prefix', fill: true },
...
export const dossierNav: BottomNavItem[] = [
	{ href: '/dossier', label: 'DOSSIER', icon: 'account_circle', group: 'dossier', match: 'prefix', fill: true },
...
export const roster = [
	...
	{ rank: '12', name: 'AGENT_092', syndicate: 'YOU // ACTIVE SESSION', rating: '1,942', discoveries: '431', active: true },
