...
<section class="scan-sweep relative overflow-hidden border bg-surface-container p-8">
	...
	<div class="relative z-10 flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
		<div class="max-w-2xl">
			<div class={`mb-4 inline-flex items-center gap-2 border px-3 py-1 font-label text-[10px] font-bold tracking-[0.28em] uppercase ${toneClass}`}>
		...
		<div class="flex w-full max-w-xs flex-col gap-3 md:items-end">
			<div class="flex size-16 items-center justify-center bg-surface-container-high text-4xl text-primary">
